...
describe("parseBotFatherReply", () => {
  ...
  it("extracts the HTTP API token from a successful creation message", () => {
    const reply = `Done! Congratulations on your new bot. You will find it at t.me/scienceswarm_alice_bot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.
...
Keep your token secure and store it safely, it can be used by anyone to control your bot.`;
    expect(parseBotFatherReply(reply)).toEqual({
      ...
      username: "scienceswarm_alice_bot",
    });
  });
...
Actually your bot lives at t.me/wobblefinch_alice_bot.
