 ...
 * argument order), ScienceSwarm breaks at runtime — and under the Phase B
 * big-bang rewrite (`docs/superpowers/specs/2026-04-13-scienceswarm-as-gbrain-layer.md`)
 * there is no `BRAIN_BACKEND` flag to roll back to. PR #231 already burned
...
describe("gbrain contract behaviors: timeline", () => {
  ...
  // will immediately flip this green. Tracked in
  // docs/PHASE_B_RESIDUAL_DEBT.md — "gbrain: addTimelineEntry is not idempotent".
