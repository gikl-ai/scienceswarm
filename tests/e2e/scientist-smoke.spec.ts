 ...
 * ---------------------------------------------------------------
 *
 * The post-pivot test plan at docs/testing/POST_PIVOT_TEST_PLAN.md
 * describes a full "connect OpenClaw → warm-start → ask Photo 51"
 ...
 *      still runs on demo data — enforced by CLAUDE.md and
 *      `.claude/rules/frontend-dashboard.md`. The chat pane does
 ...
 *
 * Related: `docs/PHASE_B_RESIDUAL_DEBT.md` tracks the migration
 * from demo-data dashboard to real gbrain-backed chat.
 */
test.fixme(
