...
Phase B of the gbrain pivot (`docs/superpowers/specs/2026-04-13-scienceswarm-as-gbrain-layer.md`)
re-homes the radar from a Next.js cron-in-the-route shape into a **gbrain
