...
description: Render the synthetic-control results as a single interactive HTML report with animated counterfactual trajectory, donor weights, placebo distribution, what-if slider, multi-outcome panel, methodology modal, and an auto-generated paper-ready Methods paragraph.
---
...
1. Build seven elements per case:
   ...
   - "What-if" treatment-year slider for in-time falsification
