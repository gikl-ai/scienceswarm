...
export const HOSTED_DESCARTES_RECOVERY_MESSAGE =
  "The Cloud Descartes critique pipeline failed before producing findings. Retry once; if it repeats, check /api/health for Descartes readiness/auth status and contact the service operator with the job trace id if one is shown.";
