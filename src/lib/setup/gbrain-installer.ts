...
/**
 * The ScienceSwarm scientist-defaults RESOLVER seed. Lifted from the
 * spec (`docs/superpowers/specs/2026-04-13-scienceswarm-as-gbrain-layer.md`,
 * "ScienceSwarm scientist-defaults schema" section). Verbatim where it
 * matters; reformatted as a brief decision tree the agent can follow.
 *
