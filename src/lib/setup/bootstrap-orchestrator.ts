...
export async function* runBootstrap(
  ...
  // a redirect loop after a fully-successful bootstrap. See
  // `docs/superpowers/plans/2026-04-15-openclaw-env-var-isolation.md`
  // and the dogfood of the `docs/install-guide` PR for the failure
