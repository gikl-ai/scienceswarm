...
/**
 * GET /api/studies/[slug]/import-summary
 *
 * Returns the latest local-only import summary for the study. Missing summaries
 * intentionally return `200` with `lastImport: null` so the dashboard can
 * render a consistent shape after reload.
 */
