# Stage 6 — render the interactive HTML report.
#
...
#   2. Donor weight bar chart with hover-readable donor weights
...
#   6. Methods paragraph
#   7. Toggleable methodology explainer
#
# Plus, page-level:
#
